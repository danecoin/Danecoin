...
"""Verify that starting danecoin with -h works as expected."""

from test_framework.test_framework import DanecoinTestFramework
from test_framework.util import assert_equal

class HelpTest(DanecoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start danecoin with -h for help text")
        ...
        self.log.info("Start danecoin with -version for version information")
        ...
        self.log.info("Start danecoind with -fakearg to make sure it does not start")
