...
# TestP2PConn: A peer we use to send messages to danecoind, and store responses.
...
class CompactBlocksTest(DanecoinTestFramework):
    ...
    # This test actually causes danecoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that danecoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for danecoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # danecoind will not send blocktxn responses for blocks whose height is
