...
class InvalidBlockRequestTest(DanecoinTestFramework):
    ...
    def run_test(self):
        ...
        # b'0x51' is OP_TRUE
        tx1 = create_tx_with_script(block1.vtx[0], 0, script_sig=b'\x51', amount=5 * COIN)
        tx2 = create_tx_with_script(tx1, 0, script_sig=b'\x51', amount=5 * COIN)
        ...
        tx3 = create_tx_with_script(tx2, 0, script_sig=b'\x51', amount=5 * COIN)
