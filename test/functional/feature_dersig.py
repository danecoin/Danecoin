...
class BIP66Test(DanecoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # danecoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and danecoind produces more specific reject
            # reasons.
