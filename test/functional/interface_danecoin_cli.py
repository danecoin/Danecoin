...
# The block reward of coinbaseoutput.nValue (50) DANE/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 DANE/block.
BLOCKS = 101
...
class TestDanecoinCli(DanecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `danecoin-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and danecoin-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 DANE) to the default wallet.
            ...
            # Test danecoin-cli -generate with -rpcwallet in multiwallet mode.
