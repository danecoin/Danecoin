...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the DanecoinTestFramework
    pass


class ExampleTest(DanecoinTestFramework):
    # Each functional test is a subclass of the DanecoinTestFramework class.
    ...
    def custom_method(self):
        ...
        DanecoinTestFramework class so other tests can use it."""
