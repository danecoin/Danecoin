...
class P2PPermissionsTests(DanecoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].danecoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].danecoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
