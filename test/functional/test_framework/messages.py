...
"""Danecoin test framework primitive and message structures
...
COIN = 100000000  # 1 dane in satoshis
MAX_MONEY = 14500000 * COIN
...
# Objects that map to danecoind objects, which can be serialized/deserialized


class CAddress:
    __slots__ = ("net", "ip", "nServices", "port", "time")

    # see https://github.com/danecoin/bips/blob/master/bip-0155.mediawiki
    NET_IPV4 = 1
...
class CTransaction:
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in danecoind
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
    ...
    def is_valid(self):
        ...
        for tout in self.vout:
            if tout.nValue < 0 or tout.nValue > 14500000 * COIN:
                return False
        return True
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in danecoind indicates these should be deserialized as blocks
