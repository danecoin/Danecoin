...
* danecoin.conf: contains configuration settings for danecoind or danecoin-qt
* danecoind.pid: stores the process id of danecoind while running
...
* debug.log: contains debug information and general logging generated by danecoind or danecoin-qt
