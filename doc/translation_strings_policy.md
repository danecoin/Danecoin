...
This document provides guidelines for internationalization of the Danecoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `danecoin_en.ts` remains unchanged.
