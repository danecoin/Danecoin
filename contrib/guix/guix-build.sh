...
# Deterministically build Danecoin Core for HOSTs (overridable by environment)
...
for host in ${HOSTS=x86_64-linux-gnu arm-linux-gnueabihf aarch64-linux-gnu riscv64-linux-gnu x86_64-w64-mingw32}; do
    ...
    (
        ...
        #     same exact path (e.g. mapping '/home/satoshi/danecoin/' to
        #     '/home/satoshi/danecoin/'). This means that the $PWD inside the
        ...
        #   --share="$PWD"=/danecoin
        #
        #                     maps our current working directory to /danecoin
        ...
        #     container so that we have something to build. '/danecoin' was
        #     chosen arbitrarily.
        #
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                      ...
                                      bash -c "cd /danecoin && bash contrib/guix/libexec/build.sh"
    )
