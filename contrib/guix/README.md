# Bootstrappable Danecoin Core Builds

This directory contains the files necessary to perform bootstrappable Danecoin
Core builds.
...
- 24GB of free disk space on the partition that the Danecoin Core git repository
  resides in
...
For a Danecoin Core depends development environment, simply invoke
...
From the top of a clean Danecoin Core repository:
...
To use dongcarl's substitute server for Danecoin Core builds after having
