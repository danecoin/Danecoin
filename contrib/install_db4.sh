...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the danecoin repository."
  exit 1
fi
...
# See https://github.com/danecoin/danecoin/issues/16064
...
echo 'When compiling danecoind, run `./configure` in the following way:'
echo
