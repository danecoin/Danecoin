...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Danecoin
else
  DOCKER_EXEC echo \> \$HOME/.danecoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/danecoin/danecoin/pull/18288#discussion_r433189350 for
  # details.
