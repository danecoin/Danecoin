...
// danecoin includes.
#include <..\src\script\danecoinconsensus.h>
...
int main()
{
    std::cout << "danecoinconsensus version: " << danecoinconsensus_version() << std::endl;
    ...
    auto op0Result = danecoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, danecoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
