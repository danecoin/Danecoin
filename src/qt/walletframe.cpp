...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, DanecoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &DanecoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &DanecoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &DanecoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &DanecoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &DanecoinGUI::updateWalletStatus);
    connect(gui, &DanecoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
