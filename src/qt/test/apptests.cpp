...
//! Entry point for DanecoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &DanecoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for DanecoinGUI tests.
void AppTests::guiTests(DanecoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &DanecoinGUI::consoleShown, this, &AppTests::consoleTests);
