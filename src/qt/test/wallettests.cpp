...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_danecoin-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_danecoin-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_danecoin-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = DanecoinUnits::formatWithUnit(unit, balance, false, DanecoinUnits::SeparatorStyle::ALWAYS);
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_danecoin-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI(m_node);
