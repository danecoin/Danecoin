    ...
    mapper(0)
{
    ...
    ui->danecoinAtStartup->setToolTip(ui->danecoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->danecoinAtStartup->setText(ui->danecoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openDanecoinConfButton->setToolTip(ui->openDanecoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
