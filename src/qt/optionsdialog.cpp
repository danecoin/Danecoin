    ...
    mapper(nullptr)
{
    ...
    ui->danecoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->danecoinAtStartup);
    ...
    ui->danecoinAtStartup->setToolTip(ui->danecoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->danecoinAtStartup->setText(ui->danecoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openDanecoinConfButton->setToolTip(ui->openDanecoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new DanecoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->danecoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openDanecoinConfButton_clicked()
{
