    ...
    platformStyle(_platformStyle)
{
    ...
    // normal danecoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying danecoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &DanecoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
