 ...
 */
#ifndef DANECOIN_UTIL_H
#define DANECOIN_UTIL_H
...
extern const char * const DANECOIN_CONF_FILENAME;
extern const char * const DANECOIN_PID_FILENAME;
...
{
    std::string s = strprintf("danecoin-%s", name);
