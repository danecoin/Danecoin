/* src/config/danecoin-config.h.  Generated from danecoin-config.h.in by configure.  */
/* src/config/danecoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef DANECOIN_CONFIG_H

#define DANECOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Danecoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Danecoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/Danecoin/Danecoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Danecoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Danecoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "danecoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://danecoin.org/"
