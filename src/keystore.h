...
#ifndef DANECOIN_KEYSTORE_H
#define DANECOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/danecoin/bips/blob/master/bip-0013.mediawiki
