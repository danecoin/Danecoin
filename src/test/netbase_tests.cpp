...
{
    BOOST_CHECK(TestSplitHost("www.danecoincore.org", "www.danecoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.danecoincore.org]", "www.danecoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.danecoincore.org:80", "www.danecoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.danecoincore.org]:80", "www.danecoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:41234", "127.0.0.1", 41234));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:41234", "127.0.0.1", 41234));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:41234", "::ffff:127.0.0.1", 41234));
    BOOST_CHECK(TestSplitHost("[::]:41234", "::", 41234));
    BOOST_CHECK(TestSplitHost("::41234", "::41234", -1));
    BOOST_CHECK(TestSplitHost(":41234", "", 41234));
    BOOST_CHECK(TestSplitHost("[]:41234", "", 41234));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:41234", "127.0.0.1:41234"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:41234", "[::]:41234"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
