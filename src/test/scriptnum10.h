...
#ifndef DANECOIN_TEST_SCRIPTNUM10_H
#define DANECOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Danecoin Core 0.10.0, for cross-comparison.
 */
public:
