...
#ifndef DANECOIN_WALLET_WALLETUTIL_H
#define DANECOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! danecoin from opening the wallet, thinking it was newly created, and
...
#endif // DANECOIN_WALLET_WALLETUTIL_H
