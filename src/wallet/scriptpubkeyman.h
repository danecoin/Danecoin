...
#ifndef DANECOIN_WALLET_SCRIPTPUBKEYMAN_H
#define DANECOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Danecoin Core wallet was originally a collection of unrelated private
...
#endif // DANECOIN_WALLET_SCRIPTPUBKEYMAN_H
