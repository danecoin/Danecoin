...
#ifndef DANECOIN_WALLET_WALLET_H
#define DANECOIN_WALLET_WALLET_H
...
public:
     ...
     * on this danecoin node, and set to 0 for transactions that were created
...
#endif // DANECOIN_WALLET_WALLET_H
