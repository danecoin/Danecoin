...
static void SetupDanecoinTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " danecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  danecoin-tx [options] <hex-tx> [commands]  Update hex-encoded danecoin transaction\n" +
            "or:     danecoin-tx [options] -create [commands]   Create hex-encoded danecoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded danecoin transaction
