 ...
 * between danecoind, and danecoin-qt and non-server tools.
*/
...
#ifndef WIN32
    gArgs.AddArg("-pid=<file>", strprintf("Specify pid file. Relative paths will be prefixed by a net-specific datadir location. (default: %s)", DANECOIN_PID_FILENAME), false, OptionsCategory::OPTIONS);
#else
