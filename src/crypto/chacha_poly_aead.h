...
#ifndef DANECOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define DANECOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@danecoin.
 *
 ...
 *
 * The chacha20-poly1305@danecoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@danecoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@danecoin are relatively fast in
...
#endif // DANECOIN_CRYPTO_CHACHA_POLY_AEAD_H
